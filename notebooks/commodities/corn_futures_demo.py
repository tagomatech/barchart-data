...
# historical OHLCV and open-interest data naturally loaded by the official
# interactive chart, draws candlesticks, and adds causal streaming indicators
# from Screamer.
#
...
# controls, or save the captured response to disk.
